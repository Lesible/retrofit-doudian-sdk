...
import io.lesible.model.request.billing.AllianceGetOrderListParam;
...
public class BillingApiTestCase {
    ...
    public void allianceGetOrderList() {
        ...
        AllianceGetOrderListParam param = AllianceGetOrderListParam.builder()
                .orderIds(orderIds).build();
        DySignRequest<AllianceGetOrderListParam> request = DySignRequest.<AllianceGetOrderListParam>builder()
