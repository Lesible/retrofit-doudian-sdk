...
public enum OrderStatus {
     ...
     * 发货前退款完结
     */
    REFUND_BEFORE_DELIVERY(21),

    /**
     * 发货后退款完结
     */
    REFUND_AFTER_DELIVERY(22),

    /**
     * 收货后退款完结
     */
    REFUND_AFTER_RECEIVE(39),
    ...
    public static OrderStatus get(Integer orderStatus) {
        if (orderStatus == null) {
            return null;
        }
        return Arrays.stream(values()).filter(it -> it.orderStatus.equals(orderStatus))
                .findAny().orElse(null);
    }
